...
def train_model(X_train, y_train, model_type='Logistic Regression'):
    if model_type == 'Logistic Regression':
        ...
        vectorizer = TfidfVectorizer()
        model = RandomForestClassifier(n_estimators=100)  # Initialize RandomForestClassifier
    else:
        raise ValueError("Invalid model type. Please choose 'Logistic Regression' or 'Random Forest'.")
